...
typedef $$ListinTableTableInsertCompanionBuilder = ListinTableCompanion
    Function({
  Value<int> id,
  required String name,
  required String obs,
...
class $$ListinTableTableTableManager extends RootTableManager<
    ...
    $$ListinTableTableProcessedTableManager,
    $$ListinTableTableInsertCompanionBuilder,
  ...
  $$ListinTableTableTableManager(_$AppDatabase db, $ListinTableTable table)
      : super(TableManagerState(
          ...
          getChildManagerBuilder: (p) =>
              $$ListinTableTableProcessedTableManager(p),
...
class $$ListinTableTableProcessedTableManager extends ProcessedTableManager<
    _$AppDatabase,
    $ListinTableTable,
    ListinTableData,
    $$ListinTableTableFilterComposer,
    ...
    $$ListinTableTableInsertCompanionBuilder,
    $$ListinTableTableUpdateCompanionBuilder> {
  $$ListinTableTableProcessedTableManager(super.$state);
}
